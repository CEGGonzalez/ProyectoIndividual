...
function Create() {
  ...
  const [errors, setErrors] = useState({
    ...
    description: "Descripcion requirida",
    image: "Imagen por defecto",
    nationality: "Nacionalidad requirida",
    dob: "FN requirida",
    teams: "Teams requirido",
    message: "",
    ok: false
  })
  ...
  return (
    <div className={styles.container}>
      ...
      {/***** COLUMNA IZQUIERDA *****/}
      <div >
        <h2 className={styles.title}>Crea Nuevo Corredor{errors.ok}</h2>
        
        {/***** IMAGEN *****/}
        <div>
          {!newDriver.image && <img src={noImage} alt="No image" className={styles.imageContainers}/>}
      ...
      <div className={styles.main}>
        ...
        <h2 style={{ marginTop: "-5px", marginBottom: "35px", color: "white" }}>{errors.ok}</h2>
          ...
          <div className={styles.formField}>
            ...
            <button onClick={handlerAddTeam} className={styles.btnIcono1} style={{marginLeft:"40px", marginTop:"8px"}}>+</button>
            </div>
            <div>
              <textarea
                ...
                readOnly
              />
              <button className={styles.btnIcono1} onClick={handleUndo}>{'\u21A9'}</button>
